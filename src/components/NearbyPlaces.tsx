...
export const NearbyPlaces: React.FC<NearbyPlacesProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[1000] flex items-center justify-center bg-black bg-opacity-50 md:p-4">
      <div className="z-[1001] flex h-full w-full flex-col bg-white shadow-xl md:max-h-[90vh] md:w-full md:max-w-4xl md:rounded-lg">
        <div className="flex-shrink-0 border-b p-4 md:p-6">
          ...
          <div className="-mx-4 mt-3 flex gap-2 overflow-x-auto px-4 pb-2 md:mx-0 md:mt-4 md:flex-wrap md:px-0">
            <button
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden">
          {loading ? (
            <div className="p-6 text-center">
              <div className="mx-auto h-10 w-10 animate-spin rounded-full border-b-2 border-blue-600 md:h-12 md:w-12"></div>
            ...
            <div className="grid grid-cols-1 gap-3 p-4 md:grid-cols-2 md:gap-4 md:p-6">
              {places.map((place) => (
                <div
                  ...
                  className="cursor-pointer rounded-lg border p-4 transition-shadow hover:border-blue-300 hover:shadow-lg"
                >
